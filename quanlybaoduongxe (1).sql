...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th7 26, 2025 lúc 06:01 PM
...
INSERT INTO `lichhen` (`MaLH`, `TenXe`, `LoaiXe`, `PhanKhuc`, `MoTaLyDo`, `nhanvien_MaNV`, `NgayHen`, `ThoiGianCa`, `PhanLoai`, `TrangThai`, `xemay_MaXE`, `khachhang_MaKH`, `MaLLV`) VALUES
(17, 'NVX 155', 'Xe tay ga', '150cc', 'rửa xe', 3, '2025-06-24', '13:00-14:00', 1, 'cho duyet', 9, 1, 9),
(18, 'NVX 155', 'Xe tay ga', '150cc', 'bảo hành', 2, '2025-06-24', '13:00-14:00', 1, 'cho duyet', 9, 1, 9),
(19, 'NVX 155', 'Xe tay ga', '150cc', 'test lần 1 ra lâm', 16, '2025-07-28', '9:00-10:00', 0, 'cho duyet', 9, 1, 15),
(20, 'NVX 155', 'Xe tay ga', '150cc', 'testlan 2 ra test01', 19, '2025-07-28', '9:00-10:00', 0, 'cho duyet', 9, 1, 15),
(21, 'NVX 155', 'Xe tay ga', '150cc', 'test lan 1 ra lam', 16, '2025-07-28', '9:30-10:30', 0, 'cho duyet', 9, 1, 17),
(22, 'NVX 155', 'Xe tay ga', '150cc', 'test lan 2 ra dat', 20, '2025-07-28', '9:30-10:30', 0, 'cho duyet', 9, 1, 17);
...
CREATE TABLE `lichlamviec` (
  ...
  `LaNgayCuoiTuan` tinyint(1) NOT NULL DEFAULT 0,
  `LaNgayNghiLe` tinyint(1) NOT NULL DEFAULT 0,
  `admin_AdminID` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(7, '2025-06-22', 'da duyet', '09:00-10:00', 1, 0, 1),
(8, '2025-06-23', 'da duyet', '10:00-11:00', 0, 0, 1),
(9, '2025-06-24', 'da duyet', '13:00-14:00', 0, 1, 1),
(10, '2025-06-22', 'da duyet', '09:00-10:00', 1, 0, 1),
(11, '2025-06-23', 'da duyet', '10:00-11:00', 0, 0, 1),
(12, '2025-07-27', 'da duyet', '13:00-14:00', 0, 1, 1),
(13, '2025-07-27', 'da duyet', '13:30-14:40', 1, 1, 1),
(14, '2025-07-27', 'da duyet', '13:30-14:40', 1, 1, 1),
(15, '2025-07-28', 'da duyet', '14:00-15:00', 1, 1, 1),
(17, '2025-07-28', 'da duyet', '9:30-10:30', 0, 1, 1);
...
INSERT INTO `nhanvien` (`MaNV`, `TenNV`, `MatKhau`, `Email`, `SDT`, `Roles`) VALUES
(16, 'Trần Quốc Lâm', '$2y$10$e85C0dlspSdgI41eY.8jvudBtQ4RBI5Qhryf73kaMQJfEt388Ryfa', 'lam@gmail.com', '1234', 'Thợ sửa xe'),
(18, 'Khang', '$2y$10$A8M23W6I2hAFLfooKv0WP.vQAiyoBcqA56G6rCX7XEj12Hre4ra0u', 'khang1@gmail.com', '12345', 'Nhân viên kế toán'),
(19, 'test01', '$2y$10$NRVlRNUyHkqC38o.lzpgTOuPAYhi1bcIqno98AFhcUziOPR./ojD.', 'test@gmail.com', '123', 'Thợ sửa xe'),
(20, 'Đỗ đức đạt', '$2y$10$SwKH972PRtcVDy04Fyuw9OONeKZeCcrEW8B0Yb1rdvPv8Jmwp/K6G', 'dat@gmail.com', '123', 'Thợ sửa xe');
...
--
-- Cấu trúc bảng cho bảng `phancong_lichlamviec`
--

CREATE TABLE `phancong_lichlamviec` (
  `MaLLV` int(11) NOT NULL,
  `MaNV` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Đang đổ dữ liệu cho bảng `phancong_lichlamviec`
--

INSERT INTO `phancong_lichlamviec` (`MaLLV`, `MaNV`) VALUES
(13, 16),
(13, 19),
(14, 16),
(14, 19),
...
--
-- Đang đổ dữ liệu cho bảng `phutungxemay`
--
...
ALTER TABLE `lichhen`
  ...
  ADD KEY `fk_lichhen_mallv` (`MaLLV`),
  ADD KEY `fk_lichhen_khachhang` (`khachhang_MaKH`),
  ADD KEY `fk_lichhen_xemay` (`xemay_MaXE`);
...
--
-- Chỉ mục cho bảng `phancong_lichlamviec`
--
ALTER TABLE `phancong_lichlamviec`
  ADD PRIMARY KEY (`MaLLV`,`MaNV`),
  ADD KEY `MaNV` (`MaNV`);
...
--
ALTER TABLE `lichhen`
  MODIFY `MaLH` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT cho bảng `lichlamviec`
--
ALTER TABLE `lichlamviec`
  MODIFY `MaLLV` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `lichhen`
  ADD CONSTRAINT `fk_lichhen_khachhang` FOREIGN KEY (`khachhang_MaKH`) REFERENCES `khachhang` (`MaKH`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_lichhen_mallv` FOREIGN KEY (`MaLLV`) REFERENCES `lichlamviec` (`MaLLV`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_lichhen_xemay` FOREIGN KEY (`xemay_MaXE`) REFERENCES `xemay` (`MaXE`) ON UPDATE CASCADE;
...
--
-- Các ràng buộc cho bảng `phancong_lichlamviec`
--
ALTER TABLE `phancong_lichlamviec`
  ADD CONSTRAINT `phancong_lichlamviec_ibfk_1` FOREIGN KEY (`MaLLV`) REFERENCES `lichlamviec` (`MaLLV`) ON DELETE CASCADE,
  ADD CONSTRAINT `phancong_lichlamviec_ibfk_2` FOREIGN KEY (`MaNV`) REFERENCES `nhanvien` (`MaNV`) ON DELETE CASCADE;
