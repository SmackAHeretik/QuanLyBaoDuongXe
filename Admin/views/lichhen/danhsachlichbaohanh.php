<div class="d-flex justify-content-between align-items-center mb-3">
  <h3>Danh sách Lịch Bảo Hành</h3>
</div>
<div class="table-responsive">
  <table class="table table-bordered table-hover align-middle">
    <thead class="table-light">
      <tr>
        <th>Mã lịch bảo hành</th>
        <th>Tên xe</th>
        <th>Loại xe</th>
        <th>Phân khúc</th>
        <th>Ngày hẹn</th>
    ...
    <tbody>
      <?php if (!empty($lichbaohanh)): foreach ($lichbaohanh as $row): ?>
      <tr>
      ...
      <?php endforeach; else: ?>
      <tr>
        <td colspan="10" class="text-center">Không có lịch bảo hành nào.</td>
      </tr>
      <?php endif; ?>
    </tbody>
  </table>
