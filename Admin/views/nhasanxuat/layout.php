    ...
    <div class="sidebar pe-4 pb-3">
      <nav class="navbar bg-light navbar-light">
        ...
        <div class="navbar-nav w-100">
          ...
          <a href="NVmanagement.php" class="nav-item nav-link"><i class="fa fa-users me-2"></i>Quản lý nhân viên</a>
          <a href="nhasanxuat.php" class="nav-item nav-link active"><i class="fa fa-industry me-2"></i>Nhà sản xuất</a>
        </div>
      </nav>
    </div>
    <!-- Sidebar End -->
