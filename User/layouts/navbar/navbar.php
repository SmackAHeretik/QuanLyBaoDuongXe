            ...
            <?php if (isset($_SESSION['TenKH'])): ?>
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="userDropdown">
                        ...
                        <li><a class="dropdown-item" href="xemlichhen.php">Xem Lịch Hẹn</a></li>

                        <li><a class="dropdown-item" href="logout.php">Đăng xuất</a></li>
                    </ul>
                </div>
                <!-- Sửa đường dẫn Đặt lịch hẹn -->
                <a class="btn custom-btn custom-border-btn ms-2" href="index.php?controller=LichHen&action=datLichForm">Đặt
                    lịch hẹn</a>
            <?php else: ?>
